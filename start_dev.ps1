...
Start-Process -FilePath "venv/Scripts/python.exe" -ArgumentList "manage.py", "runserver", "8000" -WorkingDirectory "/GestionEcole"
...
Start-Process -FilePath "npm.exe" -ArgumentList "run", "dev" -WorkingDirectory "/GestionEcole/frontend"
